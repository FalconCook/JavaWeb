...
public class CartTest {
	...
	Book book1 = new Book(1, "西游记1", "",0.01, 100, 100, "");
	Book book2 = new Book(2, "西游记2", "", 0.06, 100, 100, "");
	Book book3 = new Book(3, "西游记3", "", 12.6, 100, 100, "");
	Book book4 = new Book(4, "西游记4", "", 12.6, 100, 100, "");
	Book book5 = new Book(5, "西游记5", "", 12.6, 100, 100, "");
	Book book6 = new Book(6, "西游记6", "", 12.6, 100, 100, "");
